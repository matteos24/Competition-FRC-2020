...
public class BarrelCommandAuto extends SequentialCommandGroup {
    ...
    public BarrelCommandAuto(Drivetrain drivetrain, Vision vision) {
        addCommands
        (
            ...
            new MoveCommand(drivetrain, sqrt(150), 0.6), //Here we move across two sides of the "square" that we created around the first obstacle
            new TurnCommand(drivetrain, 90, 0.4),
            new MoveCommand(drivetrain, sqrt(150), 0.6),
            new TurnCommand(drivetrain, 90, 0.4),
              
            new MoveCommand(drivetrain, sqrt(150), 0.6),//Move to the final turn of the square
            new TurnCommand(drivetrain, 59, 0.4), //Turn to position ourselves for the second obstacle
            new MoveCommand(drivetrain, (sqrt(1275)+sqrt(150)), 0.6), //Move all the way to the start of the second obstacle
            ...
            new MoveCommand(drivetrain, (90 * sqrt(2)), 0.6), //Move all the way to start the third obstacle
            ...
            new MoveCommand(drivetain, sqrt(150), 0.6),
            new TurnCommand(drivetrain, 90, 0.4),
            new MoveCommand(drivetain, sqrt(150), 0.6), 
